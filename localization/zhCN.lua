...
do
   if (GetLocale() == "zhCN") then
      GladiusMoP.L = setmetatable({
	      -- March 20 2013 added by Cyanc @ NGACN ---
	     ["Announcements"] = "通知",
		 ["Announcements settings"] = "通知设置",
		 ["Auras settings"] = "光环设置",
		 ["CastBar"] = "施法条",
		 ["CastBar settings"] = "施法条设置",
		 ["ClassIcon"] = "职业图示",
		 ["ClassIcon settings"] = "职业图示设置",
		 ["Clicks"] = "点击执行",
		 ["Clicks settings"] = "点击执行设置",
		 ["DRTracker"] = "控场监视",
		 ["DRTracker settings"] = "控场监视设置",
		 ["Dispel"] = "驱散监视",
		 ["Dispel settings"] = "Dispel设置选项",
		 ["HealthBar"] = "生命条",
		 ["HealthBar settings"] = "生命条设置",
		 ["Highlight"] = "高亮显示",
		 ["Highlight settings"] = "高亮显示设置",
		 ["Layout"] = "编排",
		 ["Layout settings"] = "编排设置",
		 ["PowerBar"] = "能量条",
		 ["PowerBar settings"] = "能量条设置",
		 ["TargetBar"] = "目标", 
		 ["TargetBar settings"] = "目标设置", 
		 ["Timer"] = "计时器",		
         ["Timer settings"] = "计时器设置",			 
		 ["Direction"] = "框架扩展方向",  
		 ["Trinket settings"] = "饰品设置",
		 ["The Direction you want the frame to go in."] = "设置你想要框架扩展的方向",
		 ["Up"] = "上", 
		 ["Down"] = "下",		 
		 ["Left"] = "左", 
		 ["Right"] = "右", 	 
		 ["Announces when an enemy cast a dispel."] = "当一个敌对玩家施放驱散技能时发出通知", 
		 ["Dispel Grid Style Icon"] = "Grid风格图示", 
		 ["Dispel Grid Style Icon Color"] = "Grid风格驱散图示颜色", 
		 ["Dispel Grid Style Icon Used Color"] = "Grid风格驱散图示已使用颜色", 
		 ["Dispel Cooldown Spiral"] = "驱散冷却计时",
		 ["Dispel Cooldown Reverse"] = "驱散冷却反转",
		 ["Dispel Gloss"] = "覆盖驱散框架",
		 ["Dispel Gloss Color"] = "覆盖驱散框架颜色",
		 ["Dispel Icon Border Crop"] = "驱散图标边框", 
		 ["Dispel Icon Faction"] = "阵营驱散图示",
		 ["Toggle if the Dispel icon should be changing based on the opponents faction"] = "若要切换饰品图标需在对方阵营的基础上变更才行",
		 ["Dispel Frame Level"] = "驱散框架层级",
		 ["Frame level of the Dispel"] = "驱散框的架层级",
		 ["Dispel Adjust Size"] = "驱散框架 调整大小", 	 
		 ["Dispel Size"] = "驱散框架 大小值", 	 
		 ["Dispel Attach To"] = "驱散框架附加到", 	 
		 ["Attach Dispel to the given frame"] = "附加驱散框架到指定的框体", 
		 ["Dispel Position"] = "驱散框架位置", 	
		 ["Dispel Anchor"] = "驱散框架锚点",
		 ["Dispel Relative Point"] = "驱散框架相对定位",
		 ["Dispel Offset X"] = "驱散框架位移 X", 	 
		 ["Dispel Offset Y"] = "驱散框架位移 Y", 	 
		 --------------------------------------
         ["Frame"] = "框体", 
